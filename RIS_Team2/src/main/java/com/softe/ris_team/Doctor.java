...
public class Doctor extends Stage {
    ...
    private void homepage() {
        ...
        //Left toolbar
        sceneBar.getItems().addAll(homeScene, referralScene);
        ...
        home.getStylesheets().add("file:../RIS_Team2/src/main/java/com/softe/resources/cDoc.css");
    ...
    private void referral() {
        ...
        Scene refer = new Scene(scrollPane, getSceneWidth(), getSceneHeight());
        refer.getStylesheets().add("file:../RIS_Team2/src/main/java/com/softe/resources/cDoc.css");
