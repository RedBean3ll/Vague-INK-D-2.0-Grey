 ...
 * @author Matthew C
 */
public class User extends Stage {  
    ...
    private void homepage() {
        ...
        home.getStylesheets().add("file:../RIS_Team2/src/main/java/com/softe/resources/cUser.css");
    ...
    private void Invoice() {
        ...
        homeScene.setOnAction((ActionEvent s) -> {
            setSceneSize(super.getScene().getHeight(), super.getScene().getWidth());
            homepage();
        });
        ...
        HBox setOneHeadB = new HBox();
        setOneHeadB.getChildren().addAll(getImageView(), searchLabelOne, searchOne);
        HBox.setMargin(searchOne, new Insets(0, 65, 0, 0));
        setOneHeadB.setAlignment(Pos.CENTER_RIGHT);
        ...
        Scene invoice = new Scene(borderPane, getSceneWidth(), getSceneHeight());
        
        invoice.getStylesheets().add("file:../RIS_Team2/src/main/java/com/softe/resources/cUser.css");
        super.setScene(invoice);
        this.show();
